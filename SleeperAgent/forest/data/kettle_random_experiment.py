...
class KettleRandom(_Kettle):
    ...
    def prepare_experiment(self,source_class,target_class):
        ...
        self.random_construction(source_class,target_class)


    def random_construction(self,source_class,target_class):
        ...
        if self.args.local_rank is None:
            ...
            set_random_seed(self.init_seed)
        # Parse threat model
        self.poison_setup = self._parse_threats_randomly(source_class,target_class)
        self.poisonset, self.sourceset, self.validset, self.source_trainset = self._choose_poisons_randomly()

    def _parse_threats_randomly(self,source_class,target_class):
        ...
        # fix source and target class 暂时
        ...
        target_class = [target_class] * self.args.sources
        ...
        elif self.args.threatmodel == 'untargeted':
    ...
    def _choose_poisons_randomly(self):
        ...
        if self.poison_setup['poison_class'] is not None:
            ...
            for index in range(len(self.trainset)):  # we actually iterate this way not to iterate over the images
                ...
                if self.args.threatmodel == 'untargeted':
