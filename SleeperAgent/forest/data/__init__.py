...
def Kettle(args, batch_size, augmentations, mixing_method=dict(type=None, strength=0.0),
    ...
    if args.poisonkey is None:
        if args.benchmark != '':
            ...
            return KettleRandom(args, batch_size, augmentations, mixing_method, setup,custom_training_data=custom_training_data,
                                train_indices=train_indices,source_class=source_class,target_class=target_class)
