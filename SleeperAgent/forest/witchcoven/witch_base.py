...
class _Witch():
    ...
    def brew(self, victim, kettle, process=None):
    ...
    def _initialize_brew(self, victim, kettle):
        ...
        if self.args.source_criterion in ['cw', 'carlini-wagner']:
            ...
            self.source_grad, self.source_gnorm = victim.gradient(_sources, _target_classes, selection=self.args.source_selection_strategy,process=self.process)
        else:
