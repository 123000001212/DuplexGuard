...
def record_results(kettle, brewed_loss, results, args, defs, modelkey, extra_stats=dict()):
    ...
    save_to_table(args.table_path,
                  ...
                  f'{"_".join(args.net)}_{args.threatmodel}_{args.name}', args.dryrun,

                  budget=args.budget, eps=args.eps,
                  source=class_names[kettle.poison_setup['source_class']] if kettle.poison_setup['source_class'] is not None else 'Several',
